...
<h1 class=" text-center pt-2 pb-2" id="title" style="color:black">DOM MANIPULATION WITH FORM</h1>
</div>`;
...
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="Biriyani"  id="Biriyani"  name="option"/>
...
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="Fried rice"  id="Fried Rice"  name="option" />
...
<div class="form-check">
    <input  class="form-check-input"  type="checkbox"  value="Sandwich"  id="Sandwich"  name="option" />
    <label class="form-check-label" for="Sandwich">Sandwich</label>
</div>`;
form1.append(f_div6);
...
<p id="description" class="text-center">This table displays user entered information only</p>`;
